...
settingsButton.addEventListener('click', () => {
    settingsPomodoroLength.value = (pomodoroTimeLength / 60).toString();
    settingsShortBreakLength.value = (shortBreakTimeLength / 60).toString();
    settingsLongBreakLength.value = (longBreakTimeLength / 60).toString();
});
